...
export const useUpdateVariantColor = ({
  ...
  const getCurrentColor = useCallback(() => {
    ...
    const currentColorVar = typeof currentColor === 'string' ? currentColor : getClosestBreakpointValue(services.runtime, currentColor) ?? 'rgb(0, 0, 0)';
  ...
  const fromValue = useSharedValue(getCurrentColor());
