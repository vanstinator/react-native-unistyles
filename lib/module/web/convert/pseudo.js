...
export const isPseudoClass = selector => pseudoClasses.some(pseudo => selector.startsWith(pseudo));
export const isPseudoElement = selector => pseudoElements.some(pseudo => selector.startsWith(pseudo));
export const isPseudo = selector => isPseudoClass(selector) || isPseudoElement(selector);
